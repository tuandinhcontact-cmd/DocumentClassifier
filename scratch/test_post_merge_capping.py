...
def main():
    ...
    # POST-MERGE CAPPING: Cap Tech and Politics to 75,000 samples
    merged_df = apply_post_merge_capping(merged_df, 75000)
    
    print(f"Total dataset size after post-merge capping (Tech/Pol = 75k): {len(merged_df)} rows")
    ...
    print(f"\nRESULTS FOR POST-MERGE CAPPING (75k):")

...
def main():
    ...
    print(" Dữ liệu: merged_dataset.csv | Cap: 20,000 mẫu/nhãn | CV: 3-Fold")
    print("=" * 70)
    ...
    # 4. Undersampling tập Train (Capping tối đa 20,000 mẫu/nhãn)
    print("\n4. Undersampling tập Train (Cap tối đa 20,000 mẫu/nhãn)...")
    ...
    # Lưu params tốt nhất ra JSON để train_optimal đọc lại tự động
    import json
    ...
    print(   "   (train_optimal_model_to_production.py sẽ đọc file này tự động)\n")
    ...
    # 7. Huấn luyện mô hình Soft Voting Ensemble từ các mô hình tối ưu (sử dụng Softmax Regression)
    ...
    print("\n" + "=" * 70)
    print(" BẢNG SO SÁNH HIỆU NĂNG TRÊN TẬP KIỂM THỬ (TEST SET)")
    print("=" * 70)
    ...
    os.makedirs("models", exist_ok=True)
    output_model_path = "models/comparison_ensemble_model.pkl"

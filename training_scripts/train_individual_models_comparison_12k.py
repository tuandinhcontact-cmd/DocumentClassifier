...
def main():
    ...
    print(" Dữ liệu: merged_dataset.csv | Cap: 12,000 mẫu/nhãn | CV: 3-Fold")
    print("=" * 70)
    ...
    # 4. Undersampling tập Train (Capping tối đa 12,000 mẫu/nhãn)
    print("\n4. Undersampling tập Train (Cap tối đa 12,000 mẫu/nhãn)...")
    ...
    # Lưu params tốt nhất ra JSON để train_optimal đọc lại tự động (bản 12k)
    import json
    ...
    params_path = "models/best_params_12k.json"
    ...
    print("\n" + "=" * 70)
    print(" BẢNG SO SÁNH HIỆU NĂNG TRÊN TẬP KIỂM THỬ (TEST SET - 12K CAP)")
    print("=" * 70)
    ...
    output_model_path = "models/comparison_ensemble_model_12k.pkl"
